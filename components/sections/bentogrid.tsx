...
export default function BentoGrid() {
  return (
    <section className="py-24 sm:py-32" id="beneficii">
      <MaxWidthWrapper>
        <div className="relative z-10 grid grid-cols-6 gap-4">

          {/* Card 1 — 100% Personalizat */}
          <div className="relative col-span-full flex overflow-hidden rounded-2xl border bg-background p-8 lg:col-span-2 transition-colors hover:bg-muted/50">
            <div className="relative m-auto size-fit">
              <div className="relative flex h-24 w-56 items-center">
                ...
                <span className="bg-gradient-to-r from-sky-500 to-blue-600 bg-clip-text text-transparent mx-auto block w-fit font-heading text-5xl">
                  100%
                </span>
              </div>
            ...
            <div>
              ...
              <div className="relative z-10 mt-8 space-y-1.5 text-center">
                ...
                <p className="text-muted-foreground">
                  Datele tale și ale clienților tăi sunt protejate și criptate la cele mai înalte standarde GDPR și de securitate.
                </p>
              </div>
            </div>
          </div>

          {/* Card 3 — Procese accelerate */}
          <div className="relative col-span-full overflow-hidden rounded-2xl border bg-background p-8 sm:col-span-3 lg:col-span-2 transition-colors hover:bg-muted/50">
            <div>
              <svg
              ...
              <div className="relative z-10 mt-8 space-y-1.5 text-center">
                ...
                <p className="text-muted-foreground">
                  Automatizăm sarcinile repetitive, ajutând echipa ta să lucreze mai rapid, mai precis și mai eficient.
                </p>
              </div>
            </div>
          </div>

          {/* Card 4 — Colaborare în echipă */}
            ...
            <div className="grid h-full sm:grid-cols-2 gap-8">
              <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                ...
                <div className="space-y-2">
                  <h2 className="text-lg font-medium text-foreground">
                    Colaborare perfectă în echipă
                  </h2>
                  <p className="text-muted-foreground">
                    Conectează toate departamentele pe o singură platformă. Fluxuri de lucru clare, fără informații pierdute și fără comunicare fragmentată.
                  </p>
                </div>
              </div>

              {/* Workflow visual */}
              <div className="relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px before:bg-sky-500/50 sm:-my-8 sm:-mr-8">
